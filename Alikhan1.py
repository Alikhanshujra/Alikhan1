...
logo = '\n\n\x1b[1;92m\n ▄︻̷̿┻̿═━一 Ali\n  / Shujra \n   \x1b[1;93m MASTER MAFIA 2.1"\x1b[1;92m\n\x1b[1;97m----------------------------------------------\n   Author   : ALI SHUJRA\n   Github   : https://github.com/Alikhanshujra\n   Youtube  : Ali shujra yt\n----------------------------------------------\n             \x1b[1;92mFREE MODE ACTIVATED\n\x1b[1;97m------------------------------------------------\nBE SCRIPT RANA Aahil\n------------------------------------------------ '
...
def reg():
    ...
    print '\x1b[1;92m  [Connected With Ali Servers]'
...
def reg2():
    ...
    print ' \xe2\x80\xa2 THIS TOOL IS COMPLETELY CODED BY ALI SHUJRA \xe2\x80\xa2 '
...
def menu():
    ...
    print ' [2] FOLLOW ALI KHAN SHUJRA ON FB '
...
def menu_option():
    ...
    if select == '1':
        ...
        os.system('xdg-open https://www.facebook.com/100067834502170')
